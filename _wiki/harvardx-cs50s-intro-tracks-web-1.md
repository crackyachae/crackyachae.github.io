...
URL을 정확히 표시하면 `http://www.example.com`의 형태이고 이 때 HTTP는 또 다른 protocol인 HyperText Transfer Protocol의 약자로 digital envelope 안의 콘텐츠 유형을 나타낸다. 
