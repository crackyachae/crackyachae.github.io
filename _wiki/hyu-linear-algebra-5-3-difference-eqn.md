...
> + 모든 eigenvalue가 $\vert \lambda_i \vert \lt 1$을 만족하면 **_stable_**
> + 몇몇 eigenvalue는 $\vert \lambda_i \vert = 1$이고 나머지는 $\vert \lambda_i \vert \lt 1$이면 **_neutrally stable_**
> + 최소 하나의 eigenvalue라도 $\vert \lambda_i \vert \gt 1$ 이면 **_unstable_**
