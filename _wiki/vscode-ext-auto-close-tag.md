...
> 이 글은 Visual Studio Market Place의 [Auto Close Tag](https://marketplace.visualstudio.com/items?itemName=formulahendry.auto-close-tag) extension의 소개 페이지를 읽으면서 개인적으로 번역한 글입니다.
>
