...
> 이 글은 MDN Canvas Tutorial중 [Basic usage of canvas](https://developer.mozilla.org/en-US/docs/Web/API/Canvas_API/Tutorial/Basic_usage)의 내용을 복습하기위해 핵심 내용을 요약 정리한 글입니다.
>
