...
updated : 2023-09-28 12:33:08 +0900
tag     : draft
toc     : true
public  : true
...
* 참고: [React](https://react.dev) - 메인 랜딩 페이지의 설명
...
* 참고: [State: A Component's Memory](https://react.dev/learn/state-a-components-memory)
...
* 참고: [Passing Props to a Component](https://react.dev/learn/passing-props-to-a-component)
...
* 참고: [state와 props의 차이점은 무엇인가요?](https://ko.legacy.reactjs.org/docs/faq-state.html#what-is-the-difference-between-state-and-props), [props vs state](https://github.com/uberVU/react-guide/blob/master/props-vs-state.md), [ReactJS: Props vs. State](https://lucybain.com/blog/2016/react-state-vs-pros/)
    * 너무 예전 글이라 좀 고민되는듯.
...
* 참고: [Passing Data Deeply with Context](https://react.dev/learn/passing-data-deeply-with-context)
...
* 참고: [컴포넌트 생명주기](https://ko.legacy.reactjs.org/docs/react-component.html#the-component-lifecycle), [25. LifeCycle Method](https://react.vlpt.us/basic/25-lifecycle.html), [[React] 컴포넌트 라이프사이클 및 메서드](https://chanhuiseok.github.io/posts/react-9/)
...
* 참고: [shouldComponentUpdate](https://react.dev/reference/react/Component#shouldcomponentupdate), [[React] Pure Component란?](https://velog.io/@dolarge/Pure-Component란)
...
* 참고: [PureComponent](https://react.dev/reference/react/PureComponent#purecomponent), [[React] Pure Component란?](https://velog.io/@dolarge/Pure-Component란)
...
* 참고: [Functional vs Class-Components in React](https://djoech.medium.com/functional-vs-class-components-in-react-231e3fbd7108), [3 advantages of React functional components on an ecommerce site](https://blog.logrocket.com/react-functional-components-3-advantages-and-why-you-should-use-them-a570c83adb5e/)
* 추가 참고: [함수형 컴포넌트와 클래스, 어떤 차이가 존재할까? by overreacted](https://overreacted.io/ko/how-are-function-components-different-from-classes/), [왜 함수형 컴포넌트(Functional Component)를 사용하는가](https://velog.io/@dianaleee_/왜-함수형-컴포넌트Functional-Component를-사용하는가)
...
* 참고: [Built-in React Hooks](https://react.dev/reference/react), [Hook의 개요_동기](https://ko.legacy.reactjs.org/docs/hooks-intro.html#motivation)
...
* 참고: [Effect Hooks](https://react.dev/reference/react#effect-hooks), [Synchronizing with Effects](https://react.dev/learn/synchronizing-with-effects), [Using the Effect Hook](https://ko.legacy.reactjs.org/docs/hooks-effect.html)
...
* 참고: [Effect Hooks](https://react.dev/reference/react#effect-hooks), [useLayoutEffect](https://react.dev/reference/react/useLayoutEffect)
